...
class KindOfCatalog extends Kind {
    ...
    public function draw() {
        ...
        <div class="elements" align= "center">
            <div>
                <img class="catalog" src="../sources/images/green.png" width="20px" align= "left">
                <div align= "center">
                    <ul>
                        <li><i> DRAW Child </i></li>
                        <li><img id="like" src="../sources/images/heart_fill.png" width="20px" align= "center"> </li>
                    </ul>
                </div>
            </div>
            <div >
...
class DrawFactory {
    private  $items = array();
    public function __construct(array $array_items ) {
